                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="align-center mb-md-30">
                        <ul id="glasscase" class="gc-start">
                            ...
                            {{-- <li><img src="{{asset('images/webimages/1.jpg')}}" data-gc-caption="Your caption text" />
                            </li> --}}
            ...
            <div class="col-xl-7 col-lg-9 col-12">
                ...
                <div class="newsletter-input">
                    <form>
                        ...
                        <button type="submit" class="btn btn-color"><span class="d-none d-sm-block">Subscribe</span> <i
